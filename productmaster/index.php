...
<div class="header">
  ...
  <div class="welcome">
    ...
    <ul class="menu">
        ...
        <li class="menu-item">Sale Order</li>
            <ul class="submenu">
                <li><a href="../Saleorder/index.php">Sale Order</a>
            </ul>
        </li>
                ...
                while ($row = $result->fetch_assoc()) {
                    echo "
                        <tr>
                            ...
                            <td>{$row['Stock_in_Tons']}</td>
                            <td>{$row['Bin_No']}</td>
                            <td>{$row['Product_Grade']}</td>
                            <td>
                                <a class='btn btn-success' href='edit.php?no=$row[Product_id]'>Edit</a>
                                <a class='btn btn-danger' href='delete.php?no=$row[Product_id]''>Delete</a>
                            </td>
                        </tr>
                    ";
                }
